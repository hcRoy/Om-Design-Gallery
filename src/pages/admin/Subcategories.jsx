...
export default function Subcategories() {
  ...
  const filtered = useMemo(() => {
    ...
    return subcategories.filter((s) =>
      [s.name, s.slug, s.description, s.categories?.name]
        .join(" ")
        .toLowerCase()
        .includes(q),
    );
  ...
  const handleSubmit = async (e) => {
    ...
    closeModal();
    showToast(editingId ? "Subcategory updated." : "Subcategory created.", {
      type: "success",
    });
    load();
  };
    ...
    <div>
                ...
                >
                  <td className="px-5 py-3.5">
                    <div className="flex items-center gap-3">
                      ...
                      <div className="min-w-0 max-w-[16rem]" title={row.name}>
                  ...
                  <td className="px-5 py-3.5">
                    <code className="text-xs text-ink-soft bg-sand px-2 py-0.5 rounded-md whitespace-nowrap">
                      {row.slug}
                    </code>
                  </td>
      ...
      >
        ...
        >
          <FormSection
            title="Cover image"
            description="Shown when browsing subcategories under a category. Square works best."
          >
            <FileDropzone
              kind="image"
              accept="image/*"
